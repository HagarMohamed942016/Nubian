    ...
    <section class="gallery_area section_gap">
        <div class="container">
            <div class="section_title text-center">
                <h2 class="title_color">Nubain House Gallery</h2>
                <p>We work for your happiness and comfort.</p>
            </div>
        </div>
    </section>
    <!--================Home Gallery Area =================-->
            ...
            <div class="gallery_f_inner row imageGallery1">
                <div class="col-lg-3 col-md-4 col-sm-6 ap">
                    <div class="h_gallery_item">
                        <img src="images/zmz.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Nile Journey</h4></a>
                            <a class="light" href="images/zcz.jpg"><i class="fa fa-expand"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unp ap">
                    <div class="h_gallery_item">
                        <img src="images/zqzqa.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Garden Ferial</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unp">
                    <div class="h_gallery_item">
                        <img src="images/zbz.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Saloga and Gazal</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unv">
                    <div class="h_gallery_item">
                        <img src="images/zrz1.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Plants Isliand</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unp">
                    <div class="h_gallery_item">
                        <img src="images/sws.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Double Room</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unp">
                    <div class="h_gallery_item">
                        <img src="images/zmzm.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Edfou Temple</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unv">
                    <div class="h_gallery_item">
                        <img src="images/zczz.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Kommbo Temple</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unp">
                    <div class="h_gallery_item">
                        <img src="images/wwww.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Single Room</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 ap">
                    <div class="h_gallery_item">
                        <img src="images/zhzz.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Alphantin Island</h4></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 unv">
                    <div class="h_gallery_item">
                        <img src="images/weww.jpg" alt="">
                        <div class="hover">
                            <a href="#"><h4>Nubian House</h4></a>
